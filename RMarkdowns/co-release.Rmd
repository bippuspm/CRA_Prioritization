...
#ttest for overall difference in unique vs. repeated, and their overall averages (p-value = 0.04055)
t.test(repeated$onsite_releases_2017_2022, unique$onsite_releases_2017_2022, conf.level = 0.95)

repeated = tri_classified %>%
  filter(trifd_type == "repeated")
mean(repeated$onsite_releases_2017_2022) #364,847.9

unique = tri_classified %>%
  filter(trifd_type == "unique")
mean(unique$onsite_releases_2017_2022) #32,460.69
