...
#filter tri_cvi for each endpoint group (without summary numbers, like above in baseline_endpoint dfs)
```{r}
...
#repeat everything we did with baseline for climate vulnerability index to see where climate might have an impact 
...
#add groupings to climate vulnerability index dfs so I can add back into one big df; shorten MBOCA's name
```{r}
...
```{r}
#carcinogens
carc_violin_cvi = ggplot(cvi_carc, aes(x = chemical, y = CVI.Score, fill = chemical)) + geom_violin(trim = FALSE) + theme_bw() + ylab("CVI Score") + xlab("Chemical") + theme(axis.text.x = element_text(size = 10, angle = 45, hjust = 1), legend.position = "none", plot.title = element_text(hjust = 0.5)) + stat_summary(fun = mean, geom = "point", shape = 20, size = 5, color = "black", fill = "gray") + geom_hline(yintercept = mean(cvi_carc$CVI.Score), linetype = "dashed")  + scale_y_continuous(breaks = seq(0.2, 0.8, 0.1), limits = c(0.2,0.8)) + scale_fill_viridis(discrete = TRUE, option = "H", begin = 0.2) + scale_x_discrete(labels = c("3,3'-Dichlorobenzidine", "3,3'-Dichlorobenzidine 2HCl", "MBOCA*", "Acetaldehyde*", "Acrylonitrile*", "Aniline*", "Arsenic", "Benzene*", "Bromoform*", "Cadmium", "Chromium", "Creosote", "Lead", "N-Nitrosodiphenylamine", "Nickel", "Styrene*", "Vinyl Chloride*")) + ggtitle("Carcinogens")

carc_violin_cvi

ggsave(filename = "carc_violin_cvi.png", device = "png", plot = carc_violin_cvi, path = "~/TSCA/CRA/CRA_Prioritization/Output/", width = 15, height = 5)

#CNS
CNS_violin_cvi = ggplot(cvi_CNS, aes(x = chemical, y = CVI.Score, fill = chemical)) + geom_violin(trim = FALSE) + theme_bw() + ylab("CVI Score") + xlab("Chemical") + theme(axis.text.x = element_text(size = 10, angle = 45, hjust = 1), legend.position = "none", plot.title = element_text(hjust = 0.5)) + stat_summary(fun = mean, geom = "point", shape = 20, size = 5, color = "black", fill = "gray") + geom_hline(yintercept = mean(cvi_CNS$CVI.Score), linetype = "dashed")  + scale_y_continuous(breaks = seq(0.2, 0.8, 0.1), limits = c(0.2,0.8)) + scale_fill_viridis(discrete = TRUE, option = "H", begin = 0.2) + scale_x_discrete(labels = c("Acetaldehyde*", "Acrylonitrile*", "Aniline*", "Arsenic", "Benzene*", "Bromoform*", "Cyanide compounds", "Decabromodiphenyl oxide", "Ethylbenzene*", "Lead", "Styrene*", "Vinyl chloride*", "Xylene")) + ggtitle("Central Nervous System Toxicants")
...
#cardiorespiratory
cardio_violin_cvi = ggplot(cvi_cardio, aes(x = chemical, y = CVI.Score, fill = chemical)) + geom_violin(trim = FALSE) + theme_bw() + ylab("CVI Score") + xlab("Chemical") + theme(axis.text.x = element_text(size = 10, angle = 45, hjust = 1), legend.position = "none", plot.title = element_text(hjust = 0.5)) + stat_summary(fun = mean, geom = "point", shape = 20, size = 5, color = "black", fill = "gray") + geom_hline(yintercept = mean(cvi_cardio$CVI.Score), linetype = "dashed")  + scale_y_continuous(breaks = seq(0.2, 0.8, 0.1), limits = c(0.2,0.8)) + scale_fill_viridis(discrete = TRUE, option = "H", begin = 0.2) + scale_x_discrete(labels = c("Acetaldehyde*", "Acrylonitrile*", "Aniline*", "Arsenic", "Barium", "Cadmium", "Chromium", "Cobalt", "Ethylbenzene*", "Hydrogen fluoride*", "Maleic anhydride", "Molybdenum trioxide", "Naphthalene*", "Nickel")) + ggtitle("Cardiorespiratory Toxicants")
...
#EDCs
edcs_violin_cvi = ggplot(cvi_edcs, aes(x = chemical, y = CVI.Score, fill = chemical)) + geom_violin(trim = FALSE) + theme_bw() + ylab("CVI Score") + xlab("Chemical") + theme(axis.text.x = element_text(size = 10, angle = 45, hjust = 1), legend.position = "none", plot.title = element_text(hjust = 0.5)) + stat_summary(fun = mean, geom = "point", shape = 20, size = 5, color = "black", fill = "gray") + geom_hline(yintercept = mean(cvi_edcs$CVI.Score), linetype = "dashed")  + scale_y_continuous(breaks = seq(0.2, 0.8, 0.1), limits = c(0.2,0.8)) + scale_fill_viridis(discrete = TRUE, option = "H", begin = 0.2) + scale_x_discrete(labels = c("Bisphenol A*", "Chromium", "Cyanide compounds", "Decabromodiphenyl oxide", "Lead", "Nonylphenol", "Styrene*")) + ggtitle("Endocrine Disrupting Chemicals (Repro and Dev)")
...
#liver, kidney, thyroid
lkt_violin_cvi = ggplot(cvi_lkt, aes(x = chemical, y = CVI.Score, fill = chemical)) + geom_violin(trim = FALSE) + theme_bw() + ylab("CVI Score") + xlab("Chemical") + theme(axis.text.x = element_text(size = 10, angle = 45, hjust = 1), legend.position = "none", plot.title = element_text(hjust = 0.5)) + stat_summary(fun = mean, geom = "point", shape = 20, size = 5, color = "black", fill = "gray") + geom_hline(yintercept = mean(cvi_lkt$CVI.Score), linetype = "dashed")  + scale_y_continuous(breaks = seq(0.2, 0.8, 0.1), limits = c(0.2,0.8)) + scale_fill_viridis(discrete = TRUE, option = "H", begin = 0.2) + scale_x_discrete(labels = c("MBOCA*", "Bromoform*", "Cadmium", "Creosote", "Ethylbenzene*", "Hexacloro-1,3-butadiene", "Lead", "Maleic anhydride", "Molybdenum trioxide", "Styrene*", "Vinyl Chloride*")) + ggtitle("Liver, Kidney, and Thyroid Toxicants")
...
```{r}
#carc
cvi_carc_aov = aov(CVI.Score ~ chemical, data = cvi_carc)
cvi_carc_aov
cvi_carc_tukey = TukeyHSD(x = cvi_carc_aov, conf.level = 0.95)
capture.output(cvi_carc_tukey, file = "~/TSCA/CRA/CRA_Prioritization/Output/cvi_carc_tukey")

#CNS
cvi_CNS_aov = aov(CVI.Score ~ chemical, data = cvi_CNS)
cvi_CNS_aov
cvi_CNS_tukey = TukeyHSD(x = cvi_CNS_aov, conf.level = 0.95)
capture.output(cvi_CNS_tukey, file = "~/TSCA/CRA/CRA_Prioritization/Output/cvi_CNS_tukey")

#cardio
cvi_cardio_aov = aov(CVI.Score ~ chemical, data = cvi_cardio)
cvi_cardio_aov
cvi_cardio_tukey = TukeyHSD(x = cvi_cardio_aov, conf.level = 0.95)
capture.output(cvi_cardio_tukey, file = "~/TSCA/CRA/CRA_Prioritization/Output/cvi_cardio_tukey")

#edcs
cvi_edcs_aov = aov(CVI.Score ~ chemical, data = cvi_edcs)
cvi_edcs_aov
cvi_edcs_tukey = TukeyHSD(x = cvi_edcs_aov, conf.level = 0.95)
capture.output(cvi_edcs_tukey, file = "~/TSCA/CRA/CRA_Prioritization/Output/cvi_edcs_tukey")

#lkt
cvi_lkt_aov = aov(CVI.Score ~ chemical, data = cvi_lkt)
cvi_lkt_aov
cvi_lkt_tukey = TukeyHSD(x = cvi_lkt_aov, conf.level = 0.95)
capture.output(cvi_lkt_tukey, file = "~/TSCA/CRA/CRA_Prioritization/Output/cvi_lkt_tukey")
```


#getting csv of values for the above for comparison between specific chemicals
```{r}
#carc
cvi_carc_sum = summarySE(cvi_carc, measurevar = "CVI.Score", groupvars = "chemical")

write.csv(cvi_carc_sum, file = "~/TSCA/CRA/CRA_Prioritization/Output/cvi_carc_sum.csv")

#CNS
cvi_CNS_sum = summarySE(cvi_CNS, measurevar = "CVI.Score", groupvars = "chemical")

write.csv(cvi_CNS_sum, file = "~/TSCA/CRA/CRA_Prioritization/Output/cvi_CNS_sum.csv")

#cardio
cvi_cardio_sum = summarySE(cvi_cardio, measurevar = "CVI.Score", groupvars = "chemical")

write.csv(cvi_cardio_sum, file = "~/TSCA/CRA/CRA_Prioritization/Output/cvi_cardio_sum.csv")

#edcs
cvi_edcs_sum = summarySE(cvi_edcs, measurevar = "CVI.Score", groupvars = "chemical")

write.csv(cvi_edcs_sum, file = "~/TSCA/CRA/CRA_Prioritization/Output/cvi_edcs_sum.csv")

#lkt
cvi_lkt_sum = summarySE(cvi_lkt, measurevar = "CVI.Score", groupvars = "chemical")

write.csv(cvi_lkt_sum, file = "~/TSCA/CRA/CRA_Prioritization/Output/cvi_lkt_sum.csv")
```
...
#liver, kidney, thyroid
lkt_violin_env = ggplot(cvi_lkt, aes(x = chemical, y = Baseline.Vulnerability..Enviroment)) + geom_violin(trim = FALSE) + theme_bw() + ylab("Environmental Vulnerability") + xlab("Chemical") + theme(axis.text.x = element_text(size = 10, angle = 45, hjust = 1), legend.position = "none") + stat_summary(fun = mean, geom = "point", shape = 20, size = 5, color = "black", fill = "gray") + geom_hline(yintercept = mean(cvi_lkt$Baseline.Vulnerability..Enviroment), linetype = "dashed")  + scale_y_continuous(breaks = seq(0.2, 0.8, 0.1), limits = c(0.2,0.8))
